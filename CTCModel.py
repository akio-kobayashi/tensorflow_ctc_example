...
"""
Sep. 2018
Modified by Akio Kobayashi (Tsukuba Univ. of Tech.)
"""
...
class CTCModel:
    ...
    def get_loss_generator(self, generator, nb_batchs, verbose=False):
        ...
        for k in range(nb_batchs):
            ...
            if no_lab is False:
                loss_data = self.model_train.predict([x, y, x_len, y_len],
    ...
    def predict_generator(self, generator, steps,
        ...
        try:
            ...
            while steps_done < steps:
                ...
                generator_output = output_generator.__getitem__(steps_done)
